...
Vagrant.configure(2) do |config|
  #改成你的box的名字
  config.vm.box = "newfuture/yunyin"

  ### 网络配置 ###
  #端口映射
  config.vm.network "forwarded_port", guest: 80, host: 8888 #web端口，如果主机80端口空闲，可以把他改成80端
  # 使用静态,下面的注释，注释上面的
  ...
  ### 文件共享 ###
  #config.vm.synced_folder "(Vagrantfile 第18行)这里改成你放web的文件夹,如D:/YunYinSerVice/,没有请注释掉", "/var/www/html/" #主站目录 http://127.0.0.1/
